...
#include "../../Chat/opreate/FileSendThread.h"
...
void FileSendThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (FileSendThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileSendThread::mysignal)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject FileSendThread::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_FileSendThread.data,
    qt_meta_data_FileSendThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
